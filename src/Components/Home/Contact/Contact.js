    ...
    return (
        <Container>
            <Box sx={{ textAlign: 'center', my: 6, pt: 4 }}>
                <Typography sx={{ textTransform: 'uppercase', color: '#01578A', fontWeight: '700' }} variant='h3'>Contact Us</Typography>
                <Typography variant='body1'>Fill up the form and our team will get back to you within 24
                    hours.</Typography>
            </Box>
            <Grid container spacing={2}>
                <Grid item md={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <Box>
                        <img style={{ width: '100%' }} src="https://i.ibb.co/JQZKyYx/undraw-Personal-email-re-4lx7.png" alt="" />
                    </Box>
                </Grid>
                <Grid item md={6}>
                    <Box sx={{ border: '1px solid #00000021', p: 5, boxShadow: '10px 10px 30px 0px rgb(0 0 0 / 15%)' }}>
                        <Box sx={{ mb: 4, textTransform: 'uppercase', color: '#555', textAlign: 'center' }}>
