...
const MyAttendance = (props) => {
  ...
  useEffect(() => {
    fetch(`https://hr-care.onrender.com/attendance/${user.email}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://hr-care.onrender.com/employees/photo/${user.email}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://hr-care.onrender.com/employees/${user.email}`)
      .then((res) => res.json())
  ...
  const handlePunchIn = () => {
    ...
    if (today?.date === entryTime.date) {
      ...
      fetch("https://hr-care.onrender.com/attendance/", {
        method: "POST",
  ...
  const handlePunchOut = () => {
    ...
    if (today?.date === leaveTime.date) {
      fetch(`https://hr-care.onrender.com/attendance/${today._id}`, {
        method: "PUT",
        headers: { "content-type": "application/json" },
