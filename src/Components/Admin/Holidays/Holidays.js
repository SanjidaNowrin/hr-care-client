...
const Holidays = () => {
  ...
  useEffect(() => {
    fetch("https://hr-care.onrender.com/holidays")
      .then((res) => res.json())
  ...
  useEffect(() => {
    findDate.map((onedate) =>
      fetch(`https://hr-care.onrender.com/attendance/${onedate._id}`, {
        method: "DELETE",
      })
    );
  }, [findDate]);
  ...
  const handleDelete = (item) => {
    fetch(`https://hr-care.onrender.com/holidays/${item._id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
    ...
    for (
      ...
      fetch(`https://hr-care.onrender.com/attendance/date/${currentDate}`)
        .then((res) => res.json())
